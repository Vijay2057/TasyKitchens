...
class Home extends Component {
      ...
      <>
        <div className="homebg">
          ...
          <div className="homebg2">
            <Carousel variant="white">
              {carouselImages.map(each => (
                <Carousel.Item>
                  <img
                    className="d-block w-100 cauroslImg"
                    src={each.imageUrl}
                    alt="offer"
                  />
                </Carousel.Item>
          ...
          <div className="nextRests">
            ...
            <p className="pagePara" data-testid="active-page-number">
  ...
  render() {
    return (
      <>
        <Header />
        <div className="homeMainBg">{this.funCall()}</div>
      </>
    )
  }
}
